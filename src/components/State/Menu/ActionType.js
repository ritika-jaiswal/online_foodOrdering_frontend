...
export const GET_MENU_ITEMS_BY_RESTAUARANT_ID_REQUEST = "GET_MENU_ITEMS_BY_RESTAUARANT_ID_REQUES";
export const GET_MENU_ITEMS_BY_RESTAUARANT_ID_SUCCESS = "GET_MENU_ITEMS_BY_RESTAUARANT_ID_SUCCESS";
export const GET_MENU_ITEMS_BY_RESTAUARANT_ID_FAILURE = "GET_MENU_ITEMS_BY_RESTAUARANT_ID_FAILURE";
