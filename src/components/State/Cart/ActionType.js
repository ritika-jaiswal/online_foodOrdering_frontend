...
export const FIND_CERT_REQUEST = "FIND_CERT_REQUEST";
export const FIND_CERT_SUCCESS = "FIND_CERT_SUCCESS";
export const FIND_CERT_FAILURE = "FIND_CERT_FAILURE";

export const CLEARE_CART_REQUEST = "CLEARE_CART_REQUES";
